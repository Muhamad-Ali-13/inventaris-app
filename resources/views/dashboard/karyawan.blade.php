<x-app-layout>
    ...
    <!-- Header -->
    <header
        class="bg-white border-b border-white shadow-sm px-3 py-2 md:px-5 md:py-2 rounded-xl mx-3 mt-5 md:mx-8 md:mt-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="text-center md:text-left">
            <h1 class="text-xl md:text-2xl font-bold text-gray-800 leading-snug">
        ...
        <div class="flex items-center space-x-3 text-center md:text-right">
            <img src="{{ asset('image/logo.png') }}" alt="Logo"
                class="w-10 h-10 md:w-12 md:h-12 rounded-md shadow-sm mx-auto md:mx-0">
            <span class="text-gray-800 font-extrabold text-xs md:text-sm leading-tight tracking-wide">PT. Bank
                Perekonomian
                Rakyat<br>Artha Jaya Mandiri</span>
        </div>
    </header>
    ...
    <main class="py-10 bg-gradient-to-br from-white via-white to-green-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div
                    class="bg-gradient-to-r from-green-600 to-emerald-500 text-white p-6 rounded-2xl shadow-lg transform hover:scale-[1.02] transition duration-300 ease-out">
                ...
                <!-- Card Info Bulanan -->
                <div
                    class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 transform hover:scale-[1.02] transition duration-300 ease-out">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                        <h3 class="text-base md:text-lg font-semibold text-gray-700">Performa Bulanan</h3>
                        <span
                            class="px-3 py-1 text-xs rounded-full bg-green-100 text-green-700 font-medium whitespace-nowrap">{{ now()->translatedFormat('F Y') }}</span>
                    </div>
                    <p class="text-gray-500 mt-3 text-sm leading-relaxed">
                        Pantau perkembangan transaksi Anda setiap bulan dengan data yang selalu diperbarui.
                    </p>
                    <p class="text-xs text-gray-400 mt-4">Update terakhir: {{ now()->format('d M Y, H:i') }}</p>
                </div>
            </div>
