                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <li class="relative list-none">
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('departemen.index')" :class="request()->routeIs('departemen.index') ? 'text-red-500 font-bold' : ''">
                                    {{ __('Departemen') }}
                                </x-dropdown-link>
                                ...
                                <x-dropdown-link :href="route('barang.index')" :class="request()->routeIs('barang.index') ? 'text-red-500 font-bold' : ''">
                                    {{ __('Barang') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                        ...
                        <x-dropdown>
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-black dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                    <div
                                        class="text-[16px] font-bold tracking-wide {{ request()->routeIs('transaksi.index') || request()->routeIs('transaksi.create') ? 'text-[#F2994A]' : '' }}">
                                        Transaksi</div>
